...
import CreateProducts from '../Admin Dashboard/CreateProducts';
        ...
        <div>
            ...
            <div className="container-fluid">
                <div className="row flex-nowrap">
                    ...
                    <div style={{ position: "sticky", height: "100vh", top: 0, backgroundColor:'#FDACAC' }} className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg- d-none d-md-block" >
                 ...
                 <div className="col py-3">
                        ...
                        <Switch>
                            <Route exact path="/admin-dashboard/add-products">
                            <CreateProducts/>
                                {/* <h1 className="text-center">Users</h1> */}
                            </Route>
                        </Switch>
                        <Switch>
                            <Route exact path="/admin-dashboard/view-products">
                                <Products/>
                                {/* <h1 className="text-center">Users</h1> */}
                            </Route>
                        </Switch>
                        <Switch>
                            <Route exact path="/admin-dashboard/categories">
                                <Categories/>
                            </Route>
                        </Switch>
                        <Switch>
                            <Route exact path="/admin-dashboard/edit/product/:slug">
                                <EditProduct/>
                            </Route>
